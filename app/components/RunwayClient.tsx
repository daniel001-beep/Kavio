          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3.5 sm:gap-4 w-full sm:w-auto mt-4 sm:mt-0">
            <div className="bg-white border border-slate-200 p-4 sm:p-5 rounded-[20px] sm:rounded-[24px] shadow-sm flex items-center gap-3.5 sm:gap-4 w-full sm:min-w-[200px]">
              ...
              <div className="min-w-0">
                <p className="text-[9px] sm:text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-0.5 truncate">Live Cash Reserves</p>
            ...
            <div className="bg-white border border-slate-200 p-4 sm:p-5 rounded-[20px] sm:rounded-[24px] shadow-sm flex items-center gap-3.5 sm:gap-4 w-full sm:min-w-[200px]">
              ...
              <div className="min-w-0">
                <p className="text-[9px] sm:text-[10px] font-bold text-slate-500 uppercase tracking-widest mb-0.5 truncate">Live Burn Rate</p>
              ...
              <div className="space-y-6">
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">Target Cash Capital</label>
                ...
                <div>
                  <div className="flex justify-between mb-2">
                    <label className="text-xs font-bold text-slate-500 uppercase tracking-widest">Base Monthly Burn</label>
              ...
              <div className="space-y-3">
                ...
                >
                  <div className="flex items-center gap-3">
                    <Users className={`w-5 h-5 ${hireEngineers ? 'text-blue-600' : 'text-slate-500'}`} />
                    <div>
                      <p className="text-sm font-bold text-slate-700">Hire 2 Growth Engineers</p>
                      <p className="text-xs text-slate-500 font-semibold">Accelerate technical growth</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-mono text-rose-600 font-bold">+$15,000</p>
                    <p className="text-[10px] text-slate-500 font-semibold">/mo</p>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-center gap-3">
                    <Megaphone className={`w-5 h-5 ${marketingPush ? 'text-blue-600' : 'text-slate-500'}`} />
                    <div>
                      <p className="text-sm font-bold text-slate-700">Aggressive Ads Push</p>
                      <p className="text-xs text-slate-500 font-semibold">Paid acquisition & branding</p>
                    </div>
                  </div>
                  <div className="text-right">
                ...
                >
                  <div className="flex items-center gap-3">
                    <ShieldCheck className={`w-5 h-5 ${useYieldSweep ? 'text-emerald-600' : 'text-slate-500'}`} />
                    <div>
                      <p className="text-sm font-bold text-slate-700">Enable T-Bill Sweep Yield</p>
                      <p className="text-xs text-slate-500 font-semibold">Sweep cash into 5% yield</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="text-sm font-mono text-emerald-600 font-bold">-${yieldOffset.toLocaleString('en-US', { maximumFractionDigits: 0 })}</p>
                    <p className="text-[10px] text-slate-500 font-semibold">offset/mo</p>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="bg-white border border-slate-200 rounded-[24px] shadow-sm relative overflow-hidden h-full flex flex-col justify-center p-4 xs:p-6 sm:p-8 md:p-10">
              ...
              <div className="relative z-10 text-center mb-12">
                <p className="text-xs font-bold text-slate-500 uppercase tracking-widest mb-4">Consolidated Projected Runway</p>
