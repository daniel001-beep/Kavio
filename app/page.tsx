  ...
  return (
    <div className="min-h-screen bg-[#f8fafc] text-slate-900 flex flex-col font-sans selection:bg-blue-100 selection:text-blue-600 overflow-x-hidden">
      ...
      <section className="relative pt-24 pb-20 px-6 max-w-6xl mx-auto text-center flex flex-col items-center">
        ...
        {/* Centered Glowing Title (Visible Slate/Black Gradient) */}
        <h1 className="text-4xl sm:text-5xl md:text-7.5xl font-black tracking-tight leading-[1.08] max-w-4xl bg-gradient-to-b from-slate-950 via-slate-900 to-slate-800 bg-clip-text text-transparent">
      ...
      <section id="features" className="py-24 px-6 max-w-7xl mx-auto w-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="p-8 rounded-[24px] bg-white border border-slate-200/80 flex flex-col justify-between group hover:border-blue-500/40 hover:shadow-md transition-all duration-300 relative overflow-hidden shadow-sm shadow-slate-100">
            ...
            <div>
              ...
              {/* Bold black card header */}
              <h3 className="text-xl font-bold text-slate-900 mb-3">Double-Entry Engine</h3>
          ...
          <div className="p-8 rounded-[24px] bg-white border border-slate-200/80 flex flex-col justify-between group hover:border-indigo-500/40 hover:shadow-md transition-all duration-300 relative overflow-hidden shadow-sm shadow-slate-100">
            ...
            <div>
              ...
              {/* Bold black card header */}
              <h3 className="text-xl font-bold text-slate-900 mb-3">Multi-Tenant Wallets</h3>
              <p className="text-sm font-medium leading-relaxed text-slate-600">
          ...
          <div className="p-8 rounded-[24px] bg-white border border-slate-200/80 flex flex-col justify-between group hover:border-emerald-500/40 hover:shadow-md transition-all duration-300 relative overflow-hidden shadow-sm shadow-slate-100">
            ...
            <div>
              ...
              {/* Bold black card header */}
              <h3 className="text-xl font-bold text-slate-900 mb-3">Real-Time Streams</h3>
              <p className="text-sm font-medium leading-relaxed text-slate-600">
      ...
      <section id="telemetry" className="py-20 bg-white border-y border-slate-200/60 relative">
        <div className="max-w-7xl mx-auto px-6 w-full">
          <div className="text-center mb-16">
            ...
            <h2 className="text-2xl sm:text-3xl font-black text-slate-900 mt-2">Telemetry Board</h2>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 text-center">
            {/* Metric 1 */}
            <div className="p-8 border border-slate-200/80 bg-slate-50/50 rounded-2xl shadow-inner">
